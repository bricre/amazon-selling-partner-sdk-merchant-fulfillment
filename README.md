# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Merchant Fulfillment
...
```shell
composer require bricre/amazon-selling-partner-sdk-merchant-fulfillment
```
...
```php
<?php
use Amz\MerchantFulfillment\ResponseTypes;
